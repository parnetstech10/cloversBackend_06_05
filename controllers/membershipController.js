...
export const createMembership = async (req, res) => {
  try {
    const { description, benefits, price, age, type, membershipday, discount } =
      req.body;
...
export const updateMembership = async (req, res) => {
  try {
    const { id } = req.params;
    const { description, benefits, price, type, membershipday, age, discount } =
      req.body;
    const updatedMembership = await Membership.findByIdAndUpdate(
      id,
      { description, benefits, price, type, membershipday, age, discount },
      { new: true }
    );
...
export const renewMembership = async (req, res) => {
  try {
    const { userName, membershipId, membershipName, membershipType } = req.body;
